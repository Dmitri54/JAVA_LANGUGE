package OOP_JAVA.lessons.les_04.Ex008;
...
public class Ex003_Game {
    public static void main(String[] args) {
        ...
        // var st1 = new Team<String>("string team 1"); // Теперь нельзя.
...
class Team<T extends Programmer> { // Тип <T> в иерархии Programmer
    private String name;
...
class Olympiad<T extends Programmer> { // Тип <T> в иерархии Programmer
