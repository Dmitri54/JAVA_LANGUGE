...
// Но если я поставлю инкремент в вызове функции (System.out.println(a++);) получу значение (123).
// т.е. не сработал.
// Но если я добавлю напишу (System.out.println(a);) получу значение (124).
