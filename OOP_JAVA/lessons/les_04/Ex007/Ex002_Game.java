package OOP_JAVA.lessons.les_04.Ex007;
...
// Подчеркивает красным. Не дает добавить Middle в команду Intern.
        ...
        // #region
        var st1 = new Team<String>("string team 1"); // Это проблема. Команда строк?
// Ex008 - Решение: Тип <T> в иерархии Programmer
...
class Team<T> { 
// Тут указываю тип <T> и дальше я смогу в момент создания команды каким типом нужно будет закрыть 
// тип <T>.
    private String name;
...
class Olympiad<T> { // Олимпида будет проводиться с командами, которые имеют один и тот же тип.
