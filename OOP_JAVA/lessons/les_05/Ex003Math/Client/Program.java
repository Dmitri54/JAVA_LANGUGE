...
import OOP_JAVA.lessons.les_05.Ex003Math.Mathematics.CalculateArea.CalculateArea;
...
public class Program {
    public static void main(String[] args) throws UnacceptableValueException {
        ...
        new App().start(); // структура MVP.

        // #region

//         Shape shape1 = Circle.create(1, "Circle_1");
// // Создал фигуру типа Circle и передаю аргументы.
