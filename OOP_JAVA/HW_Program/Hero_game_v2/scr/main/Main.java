package OOP_JAVA.HW_Program.Hero_game_v2.scr.main;

import OOP_JAVA.HW_Program.Hero_game_v2.scr.main.Units.Crossbowman;
import OOP_JAVA.HW_Program.Hero_game_v2.scr.main.Units.Farmer;
import OOP_JAVA.HW_Program.Hero_game_v2.scr.main.Units.Mag;
import OOP_JAVA.HW_Program.Hero_game_v2.scr.main.Units.Monk;
import OOP_JAVA.HW_Program.Hero_game_v2.scr.main.Units.Outlaw;
import OOP_JAVA.HW_Program.Hero_game_v2.scr.main.Units.Sniper;
import OOP_JAVA.HW_Program.Hero_game_v2.scr.main.Units.Spearman;
import OOP_JAVA.HW_Program.Hero_game_v2.scr.main.Units.Unit;
        ...
        for (int i = 1; i <= UNITS; i++) {
            ...
            switch (rnd){
                ...
                case (2):
                    ...
                    break;
                case (3):
                    team.add(new Farmer(Unit.getName(),i, posY));
                    break;
                case (4):
