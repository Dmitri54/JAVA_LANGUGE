...
//         // public - значит, что метод main виден снаружи класса, т.е. это значит, что 
...
//         // И далее указатель со строки str будет переадресован на новую строку.
...
//             // .contains(); - метод (contains - содержит внутри себя) применяется к строке, если содержит,
//             // то true, если нет - false.
//             // Если .contains(); содержит (,) или (.) или (!), то я попадаю в тело условия. | - или, 
//             // проверит все условия.
...
//             // если первая строка равна или не равна второй строке.
