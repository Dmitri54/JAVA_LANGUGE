...
public class Ex001_Program {
    ...
    public static void main(String[] args) {
        ...
        Worker w1 = new Worker(); // Создаю экземпляр класса Worker.
// Характеристики его:
        w1.firstName = "Имя_1";
...
// Не равны т.к. это сложные объекты и нужно прописать метод сравнения этих экземпляров класса Worker.
        System.out.println(w1.equals(w4)); // true
// Создаю коллекцию экземпляров класса Worker. 
