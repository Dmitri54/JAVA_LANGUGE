...
public class Program {
    public static void main(String[] args) {
        ...
        // videoContent.add(new VideoContent("ВИДЕО 1")); // Создал несколько репозиториев
        // videoContent.add(new VideoContent("ВИДЕО 2"));
        
        // pTchaikovsky.merge(videoContent); // Метод - позволяет слить два в один.
// .merge - этот метод не описан.
