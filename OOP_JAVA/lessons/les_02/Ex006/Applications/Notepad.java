package OOP_JAVA.lessons.les_02.Ex006.Applications;

import java.util.ArrayList;
import java.util.List;

import OOP_JAVA.lessons.les_02.Ex006.Document.TextDocument;
import OOP_JAVA.lessons.les_02.Ex006.Format.TextFormat;

public class Notepad {
    private List<TextDocument> documents; 
// Рализован documents по средствам коллекции List параметризированным типом <TextDocument>.
    private int index;
