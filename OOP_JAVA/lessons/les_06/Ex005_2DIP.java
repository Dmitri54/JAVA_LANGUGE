...
class BookDIP {
    ...
    public void setView(ViewDIP view) { // Тут в качестве контсруктора передается конеретный представитель ViewDIP
        this.view = view;
    }

    int indexPage;

    public BookDIP(ViewDIP view) { // Книга работает с обстракцией 
        this.view = view;
        indexPage = 1;
    }
