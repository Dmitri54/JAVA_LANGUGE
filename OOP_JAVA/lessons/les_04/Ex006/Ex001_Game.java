package OOP_JAVA.lessons.les_04.Ex006;
...
public class Ex001_Game {
    ...
    // Тут явно должна выиграть, но нет параметров и функции, для взвешивания программистов.
...
abstract class Programmer { // Некий программис (abstract class)
...
class Team { // Формирую команду.
    private String name;
    private List<Programmer> programmers; 
// В качестве хранилища буду использовать коллекцию <Programmer>
...
class Olympiad { // Описал сущность, позволяющую свести две команды
